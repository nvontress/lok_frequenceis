...
load("~/Documents/lok_frequencies/frequency_analysis_ci_cyano_workspace.RData")
...
lake_station_coords <- vect(lake_station_coords_w)
...
# Unwrap spatial data
lake_bound <- vect(lake_bound_w)
nw_quad <- vect(nw_quad_w)
ne_quad <- vect(ne_quad_w)
sw_quad <- vect(sw_quad_w)
se_quad <- vect(se_quad_w)
roi <- vect(roi_w)
...
generate_bloom_tib <- function(chla = lake_chla,
  ...
  crop(station_coords,bound)$station_id -> stations
...
#   filename = 'annual_freq_quads_plot_redo_2.png',
#   path = '/Users/natalie/Documents/thesis_writing/r_plots',
#   width = 6.5,
#   height = 4,
#   units = 'in',
...
#   filename = 'monthly_freq_quads_plot_redo_2.png',
#   path = '/Users/natalie/Documents/thesis_writing/r_plots',
#   width = 6.5,
#   height = 4,
#   units = 'in',
...
#   filename = 'annual_freq_plot_all.png',
#   path = '/Users/natalie/Documents/thesis_writing/r_plots',
#   width = 6.5,
#   height = 7,
#   units = 'in',
...
#   filename = 'monthly_freq_plot_all.png',
#   path = '/Users/natalie/Documents/thesis_writing/r_plots',
#   width = 6.5,
#   height = 7,
#   units = 'in',
